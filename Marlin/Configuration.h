...
#define STRING_CONFIG_H_AUTHOR "(Andrew W, Ender-5 Pro)" // Who made the changes.
 ...
 * This is the default communication speed for all serial ports.f
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  // and placed inside the small Creality printer enclosure tent.flcd*ui
  //
...
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT { 80, 80, 800, 419 }
#endif
 ...
 *  - Use 5V for powered (usually inductive) sensors.s
 *
...
// #define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 90, 90, 180, 180 } // (mm) Left, Front, Right, Back insets
  // #define TRAMMING_POINT_XY { { 50, 20 }, { 200, 50 }, { 200, 20 }, { 50, 200 } }
   ...
   * Examples:
   *
   *      Default        {LF,RB,LB,RF}         {LF,RF}           {LB,LFf}
